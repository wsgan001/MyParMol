...
public DotLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("s", this), new Integer(29));
	literals.put(new ANTLRHashString("se", this), new Integer(28));
	literals.put(new ANTLRHashString("sw", this), new Integer(30));
	literals.put(new ANTLRHashString("e", this), new Integer(27));
	literals.put(new ANTLRHashString("n", this), new Integer(25));
	literals.put(new ANTLRHashString("digraph", this), new Integer(22));
	literals.put(new ANTLRHashString("ne", this), new Integer(26));
	literals.put(new ANTLRHashString("w", this), new Integer(31));
	literals.put(new ANTLRHashString("nw", this), new Integer(32));
