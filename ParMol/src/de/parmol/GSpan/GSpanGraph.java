...
public class GSpanGraph {
     ...
     * @param factory
     */
    public GSpanGraph(ClassifiedGraph realGraph, Relabler node, Relabler edge, GraphFactory factory){
        ...
        for (int i=0;i<realGraph.getEdgeCount();i++){
            ...
            if (edge.getLabel(lab)!=Graph.NO_EDGE 
                ...
                me.addEdge(nodes[realGraph.getNodeA(e)],nodes[realGraph.getNodeB(e)],edge.getLabel(lab));
            }
        }
        //TODO: delete empty nodes
/*        for (int i=0;i<me.getNodeCount();i++){
            if (me.getDegree(me.getNode(i))==0) me.removeNode(me.getNode(i));
        }*/
    }
        ...
        return new Iterator(){
            ...
            public Object next(){
                if (hasNext()){
                    ...
                    return new GSpanEdge(me.getNodeLabel(me.getNodeA(edge)),me.getEdgeLabel(edge),me.getNodeLabel(me.getNodeB(edge)));
    ...
    public void remove(GSpanEdge edge){
        ...
        while (deleted){
            ...
            for (int i=0;i<me.getEdgeCount()&&!deleted;i++){
                ...
                if ((me.getNodeLabel(nodeA)==edge.labelA && me.getNodeLabel(nodeB)==edge.labelB 
                        && me.getEdgeLabel(realEdge)==edge.edgeLabel) 
                     || (me.getNodeLabel(nodeA)==edge.labelB && me.getNodeLabel(nodeB)==edge.labelA 
                        && me.getEdgeLabel(realEdge)==edge.edgeLabel)){
    ...
    public ClassifiedGraph getRealGraph(){ return realGraph; }
    /** @return the number of Edges, remaining in this GSpanGraph */
    public int getEdgeCount(){ return me.getEdgeCount(); }
