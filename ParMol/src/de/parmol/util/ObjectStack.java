...
/**
 * This class represents a stack that holds Objects. It grows if more space is needed (but does not shrink).
 * 
...
public class ObjectStack {
  ...
  /**
   * Creates a new stack for Objects.
   * @param initialSize the initial size of the stack
   */
  public ObjectStack(int initialSize) {
    m_stack = new Object[initialSize];
  }
  
  /**
   * Creates a new stack for Objects with a default size (of currently 256).
   */  
  public ObjectStack() { this(256); }
  ...
  public void push(Object value) {
    if (m_pointer >= m_stack.length) {
      Object[] temp = new Object[m_stack.length + 64];
