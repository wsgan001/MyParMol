...
import de.parmol.MoFa.RingGraph;
...
public class Util {
	 ...
	 * @throws Util.TooManyCyclesException if the graph has more than MAX_CYCLES cycles
	 */
	public static int markCycles(RingGraph graph, int minSize, int maxSize) throws Util.TooManyCyclesException {
