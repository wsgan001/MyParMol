...
import de.parmol.graph.ListGraph;
...
public class ListGraphTest extends TestCase {
   ...
   * @param name
   */
  public ListGraphTest(String name) {
    super(name);
  }

  public void testAdd() {
  	GraphGenerator.instance.setGraphFactory(UndirectedListGraph.Factory.instance);
    ListGraph g1 = (ListGraph) GraphGenerator.instance.generateGraph(20, 200);
  ...
  public void testConvert() {
    ...
    ListGraph g2 = new UndirectedListGraph(g1);
  ...
  public void testCopy() {
  	GraphGenerator.instance.setGraphFactory(UndirectedListGraph.Factory.instance);
    ListGraph g1 = (ListGraph) GraphGenerator.instance.generateGraph(20, 200);
    ListGraph g2 = (ListGraph) g1.clone();
